...
//  Serial.println();
  ...
  //*********************************** QUIZ ********************************************//
  Serial.println("\t\t\t\t ************ QUIZ ************ \n");
  Serial.println("Question 1: Mehdi a t-il 30 ans ?");
  Serial.println("Question 2: Est-ce que la planète Terre est la troisième planète du système solaire ? ");
  Serial.println("Question 3: Est-ce que les projets sont intéressants ?");
  //Serial.println("**************************************************************************** \n");
  Serial.println("\n\t\t\t\t ************ Answers ************ \n");
...
void loop() {
  ...
  if (invokeStatus != kTfLiteOk) {
    ...
    for (int i = 0; i < NUM_GESTURES; i++)
    {
      ...
      { 
        Serial.print("Reponse ");Serial.print(j);Serial.print(": ");
